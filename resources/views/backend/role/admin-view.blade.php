            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                          Data Admin <span class="badge badge-pill badge-primary">{{ count($adminuser) }}
                        </h3>
                        ...
                        <div class="table-responsive">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td> 
                                          <img src="{{ (!empty($item->profile_photo_path))? url('upload/admin-images/'.$item->profile_photo_path):url('upload/no-image.jpg') }}"
