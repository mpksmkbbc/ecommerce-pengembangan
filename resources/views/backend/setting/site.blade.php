                                ...
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <h5>Nomor Telepon 1 <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                            ...
                                            <div class="form-group">
                                                <h5>Nomor Telepon 2 <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <h5>Deskripsi Perusahaan <span class="text-danger">*</span></h5>
                                                <div class="controls">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="file" name="logo" class="form-control" id="logoImage">
                                                </div>
                                                <img id="showImage" src="{{ url($setting->logo) }}" 
                                                style="width: 100px; height: 36px; margin-top: 20px;" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end row -->
