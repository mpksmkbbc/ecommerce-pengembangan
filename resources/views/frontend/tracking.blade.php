        ...
        <div class="card-body">
            <div class="row" style="margin-left: 30px; margin-top: 20px;">
                ...
                <div class="col-md-2">
                    ...
                    {{ $track->province->province_name }} / {{ $track->city->city_name }}
                </div> <!-- // end col md 2 -->
            ...
            <div class="track">
                @if($track->shipping_status == 'Ditunda')
                ...
                @elseif($track->shipping_status == 'Di konfirmasi')
                ...
                @elseif($track->shipping_status == 'Dikemas')
                ...
                @elseif($track->shipping_status == 'Dikirim')
                ...
                @elseif($track->shipping_status == 'Dalam Perjalanan')
                ...
                @elseif($track->shipping_status == 'Selesai')
