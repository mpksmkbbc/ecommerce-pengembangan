                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_weight" placeholder="Berat Produk"
                                                    class="form-control">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_qty" placeholder="Jumlah Stok Produk"
                                                    class="form-control">
                                                @error('product_qty')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="product_price" placeholder="Harga Produk"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea name="product_short_desc" id="textarea" class="form-control"
                                                    required placeholder="Deskripsi Pendek"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea id="editor1" name="product_long_desc" rows="10" cols="80"
                                                    required=""
                                                    placeholder="Deskripsi Panjang">Deskripsi Panjang</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="controls">
                                                <select name="subsubcategory_id" class="form-control" required="">
                                                    <option value="" selected="" disabled="">Sub-Sub Kategori
                                                    </option>
                                                </select>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="controls">
                                                <input type="file" name="product_gallery[]" for="galeri"
