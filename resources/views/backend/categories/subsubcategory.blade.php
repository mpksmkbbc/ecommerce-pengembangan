...
<div class="container-full">
    ...
    <section class="content">
        <div class="row">
          <!-- Daftar Data Sub-Sub Kategori -->
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sub-Sub Kategori 
                          <span class="badge badge-pill badge-primary">{{ count($subsubcategories) }} </span>
                        </h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('subsubcategory.edit', $item->id) }}" class="btn btn-sm btn-info" 
                                              title="Edit Data">
                                              <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="{{ route('subsubcategory.delete', $item->id) }}" class="btn btn-sm btn-danger"
